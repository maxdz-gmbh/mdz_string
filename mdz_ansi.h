...
#ifndef MDZ_STRING_ANSI_H
#define MDZ_STRING_ANSI_H
 ...
 * Synchronous version
 */
#define mdz_ansi_insertDoubleZerowed(pAnsi, nLeftPos, pcItems, bReserve) mdz_ansi_insertDoubleZerowed_async(pAnsi, nLeftPos, pcItems, bReserve, NULL)
